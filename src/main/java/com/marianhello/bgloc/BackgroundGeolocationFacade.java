...
public class BackgroundGeolocationFacade {
    ...
    public BackgroundLocation getCurrentLocation(int timeout, long maximumAge, boolean enableHighAccuracy) throws PluginException {
        ...
        try {
            ...
            if (location != null) {
                BackgroundLocation backgroundLocation = BackgroundLocation.fromLocation(location);
                backgroundLocation.setBattery(BatteryManager.getBatteryPercentage(mContext));
